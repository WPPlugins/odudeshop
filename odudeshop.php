...
function odude_meta_box_purchase_min_qty()
{
	...
	<tr><td><input size="10" type="text" name="odudes_list[pextra_one1]" value="<?php if(isset($pextra_one1)) echo $pextra_one1;?>"> </td><td><input size="10" type="text" name="odudes_list[pextra_one]" value="<?php if(isset($pextra_one)) echo $pextra_one;?>"></td></tr>
	<tr><td><input size="10" type="text" name="odudes_list[pextra_two1]" value="<?php if(isset($pextra_two1)) echo $pextra_two1;?>"> </td><td><input size="10" type="text" name="odudes_list[pextra_two]" value="<?php if(isset($pextra_two)) echo $pextra_two;?>"></td></tr>
	</table>
    <?php
    }
